...
import me.roybailey.springboot.KickstartGraphQLServerApplication;
...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, classes = {ApplicationTestConfiguration.class, KickstartGraphQLServerApplication.class})
